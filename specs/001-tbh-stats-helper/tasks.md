...
- [ ] **T068 — Дизайн виджета в стиле игры + чекбокс «поверх окон» + кнопка увода окна игры за экран.** Три связанных направления оформления/поведения виджета (`TBHStats.App`, FR-014…FR-016). **Scope переопределён пользователем 2026-06-02:** пункты «Примагничивание (snap/docking)» и «Адаптивная ширина» исключены; вместо них — чекбокс topmost и кнопка скрытия окна игры (ниже).
